...
public class create_mesh : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 頂点座標の指定.
        newVertices[0] = new Vector3(-0.3f, 0.0f, 1.0f);
        newVertices[1] = new Vector3(-1.5f, 0.0f, -1.0f);
        newVertices[2] = new Vector3(1.5f, 0.0f, -1.0f);
        newVertices[3] = new Vector3(0.3f, 0.0f, 1.0f);
